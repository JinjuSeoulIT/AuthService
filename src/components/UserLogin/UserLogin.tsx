...
import { LoginInputRequest } from "@/components/features/login/LoginSlict";
...
export default function UserLogin() {
  ...
  const { loginRes, loading, error } = useAppSelector((s) => s.login);
      ...
      <div className={styles.card}>
        ...
        <form className={styles.form} onSubmit={onSubmit}>
          ...
          <div className={styles.footerRow}>
            <a className={styles.link} href="/member/signup">
              회원가입
            </a>
