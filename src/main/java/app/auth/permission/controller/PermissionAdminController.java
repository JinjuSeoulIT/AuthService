...
public class PermissionAdminController {
    ...
    public ResponseEntity<ApiResponse<List<PermissionRoleResponse>>> getRoles() {
        ...
        return ResponseEntity.ok(new ApiResponse<List<PermissionRoleResponse>>().ok(roles));
    }
    ...
    public ResponseEntity<ApiResponse<List<RoleMenuPermissionResponse>>> getRoleMenus(@PathVariable String roleCode) {
        try {
            ...
            return ResponseEntity.ok(new ApiResponse<List<RoleMenuPermissionResponse>>().ok(menus));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest()
                    .body(new ApiResponse<List<RoleMenuPermissionResponse>>().error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateRoleMenus(@PathVariable String roleCode,
        ...
        try {
            ...
            return ResponseEntity.ok(new ApiResponse<Void>().ok("Role menu permissions saved."));
        } catch (IllegalArgumentException e) {
    ...
    public ResponseEntity<ApiResponse<List<PermissionUserResponse>>> searchUsers(@RequestParam(required = false) String keyword) {
        ...
        return ResponseEntity.ok(new ApiResponse<List<PermissionUserResponse>>().ok(users));
    }
    ...
    public ResponseEntity<ApiResponse<List<UserMenuPermissionResponse>>> getUserMenus(@PathVariable String userId) {
        try {
            ...
            return ResponseEntity.ok(new ApiResponse<List<UserMenuPermissionResponse>>().ok(menus));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest()
                    .body(new ApiResponse<List<UserMenuPermissionResponse>>().error(e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse<Void>> updateUserMenus(@PathVariable String userId,
        ...
        try {
            ...
            return ResponseEntity.ok(new ApiResponse<Void>().ok("User menu override saved."));
        } catch (IllegalArgumentException e) {
            return ResponseEntity.badRequest().body(new ApiResponse<Void>().error(e.getMessage()));
        }
    }
